...
<body class="hold-transition sidebar-mini sidebar-mini sidebar-collapse">
    <div class="wrapper">
                                    ...
                                    <ul aria-labelledby="dropdownSubMenu3" class="dropdown-menu border-0 shadow">
                                        ...
                                        <li class="dropdown-submenu">
                                            <a id="dropdownSubMenu3" href="#" role="button"
                                                ...
                                                class="dropdown-item dropdown-toggle">3rd level</a>
                                            <ul aria-labelledby="dropdownSubMenu3"
                                                class="dropdown-menu border-0 shadow">
                                                <li><a href="#" class="dropdown-item">4th level</a></li>
                                                <li><a href="#" class="dropdown-item">4th level</a></li>
                                            </ul>
                                        </li>
                                    </ul>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; 2019 <a href="#">Gunkul Engineering Public Company Limited</a>.</strong> All
            rights reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
